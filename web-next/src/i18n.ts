...
const en: Translations = {
  ...
  bonusSuccessBody: 'You solved the bonus challenge too. That was the hardest puzzle. You are a real proof pro!',
...
const de: Translations = {
  ...
  bonusSuccessBody: 'Wahnsinn! Du hast auch die Bonus-Aufgabe gelöst. Du bist ein echter Beweis-Profi!',
